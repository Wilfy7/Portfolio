     ...
     <div className="section-behere">
      ...
      <div className="let-container">
       ...
       <div className="attributes-section">
         ...
         <svg   viewBox="0 0 16 16" className="fi">
         ...
         <div className="attribute-items">
         <svg  className="fi" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
         ...
         <div className="attribute-items">
         <svg className="fi" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 489.3 489.3">
           <g>
         ...
         <div className="attribute-items">
         <svg 
            className="fi" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
         ...
         <div className="attribute-items">
         <svg  className="fi"
             version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 472.618 472.618" 
           >
            <g>
	           <g>
		            <path 
                  d="M380.525,337.291c-135.427,0-245.302-109.773-245.302-245.302c0-32.502,6.338-63.575,17.991-91.988
        ...
        <div className="attribute-items">
          <svg className="fi" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             <g>
      ...
      <div className="img2-container fixed-mid">
        ...
        <div className="img-container2">
         ...
         <div className="img-caption item">
